...
// include: /tmp/tmpu0iwl5sy.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/home/red/zig-server/public/game.data';
...
Module['FS_createPath']("/assets/vs_ai", "frames", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['FS_createDataFile'](name, null, data, true, true, true);
          ...
          Module['removeRunDependency']('datafile_/home/red/zig-server/public/game.data');
      }
      Module['addRunDependency']('datafile_/home/red/zig-server/public/game.data');
...
var _updateFrame = Module['_updateFrame'] = makeInvalidEarlyAccess('_updateFrame');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['updateFrame'] != 'undefined', 'missing Wasm export: updateFrame');
  ...
  _updateFrame = Module['_updateFrame'] = createExportWrapper('updateFrame', 0);
